Vue.component('contact_form_1722238235', {
  template: `
    <main class="flex justify-center align-center p-10">
      <div class="w-fit max-w-lg p-8 bg-white shadow-lg rounded-lg">
        <div>
          <h3 class="text-black font-semibold text-xl">Join the Culture</h3>
          <p class="mt-3 text-black w-fit">Let's build a society of freedom, abundance and well-being.</p>
        </div>
        <form @submit.prevent class="space-y-5 mt-5">
          ...
          <div>
            <label class="font-medium text-black">What are your skills?</label>
          ...
          <div>
            <label class="font-medium text-black">What is your vision?</label>
          ...
          <button class="w-full px-4 py-2 text-white font-medium bg-green-600 hover:bg-green-500 active:bg-green-700 rounded-lg duration-150">How can you contribute?</button>
        </form>
      </div>
    </main>
  `,
